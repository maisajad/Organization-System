...
<title>Apply promotion Screen</title>
<style type="text/css">
body {
	font-family:  Calibri;
...
<body>
	<jsp:include page="/canPromotionServlet" />
	<%
	...
	<div class="alert <%=request.getAttribute("alertClass")%>">
		<span class="closebtn"
			onclick="this.parentElement.style.display='none';">&times;</span> You
		can't apply for a promotion :(
	</div>
	<%
	} else {
	%>
