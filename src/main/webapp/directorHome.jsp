...
<title>Director Home Screen</title>
<style type="text/css">
body {
	font-family:  Calibri;
...
<body>
	...
	<h2>Director Features</h2>
	<div class="grid-container">
		<div class="grid-item">
			<a href="directorViewAchievements.jsp">View employees
				achievements</a>
		</div>
		<div class="grid-item">
			<a href="directorTransferRequests.jsp">View transfer requests</a>
		</div>
		<div class="grid-item">
			<a href="directorPromotionRequests.jsp">View promotion requests</a>
		</div>
	</div>
